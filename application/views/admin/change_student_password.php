...
<?php }?></li>
                                ...
                                <ul id="myTab3" class="tab-review-design">
                                   <br> <li class="active"><a href="#description"><i class="" aria-hidden="true"></i> Change Student Password</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <?php echo form_open_multipart("Adminctlr/change_student_password");?>
