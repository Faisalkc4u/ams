...
<!--                                    <li class="active"><a href="Add Student.html"><i class="" aria-hidden=""></i>View Registered Stuents</a></li>-->
        ...
        <div class="data-table-area mg-tb-15">
                                    ...
                                    <h1>List of Drop Out Students</h1>
                                </div>
                            </div>
                            
                                   <br><br><br><br><br> <table data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        data-cookie-id-table="saveId" data-show-export="" >
                                        <thead>
                                            <tr>
                                                <!--<th data-field="state" data-checkbox="true"></th>-->
                                                <th data-field="id">Admission No</th>
                                        ...
                                        <tbody>
                                           <?php
                                               ...
                                               <td><?php echo $user->yearofdrop;?></td>
...
?>
     ...
     <br><br><br><br><br><br><br><br> <br><br><br><br><br><br> <br><br><br><br><br><br> <br><br> <div class="footer-copyright-area">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
