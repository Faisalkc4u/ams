                        ...
                        <!--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">-->
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="Add Student.html"><i class="" aria-hidden="true"></i> Drop Course </a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <?php 
echo form_open_multipart("Adminctlr/drop");
?>
    
               
                                                   <table><tr><td style="width:40%"><br> Course</td>
                                                   ...
                                                   <?php
                                                    ...
                                                    <option value="<?php echo $user->course_name?>"><?php echo $user->course_name?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select></td><tr>
     ...
     <tr><td><br> <input type="submit" value="Drop" name="d"></td></tr>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>SIST KANNUR UNIVERSIT CAMPUS<a href=""></a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
