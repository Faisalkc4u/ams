                        ...
                        <!--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">-->
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="" aria-hidden="true"></i>View Internals</a></li>
...
<script>
        ...
        $.ajax({
           url:"<?php echo base_url();?>index.php/Adminctlr/view_internal?data="+course+"|"+sem,
           method:"get",
