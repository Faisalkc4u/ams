...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href=
          "<?php echo base_url(); ?>assets/img/favicon.ico">
    <!-- Google Fonts
		============================================ -->
                ...
                <div class="container-fluid">
                    <div class="">
                                ...
                                <ul id="myTab3" class="tab-review-design">
                                   <br> <h4>View Registered Students</h4>
                                ...
                                <div id="" class="">
                                    ...
                                    <?php echo form_open_multipart("Adminctlr/student_details");?>                               
     
        <select class="form-control" name="field">
            <option selected="selected" disabled="disabled" value="">Filter By</option>
            <option value="adno">Admission No</option>
...
?>                                         
        ...
        <div class="data-table-area mg-tb-15">
                                   ...
                                   <br><br><br><br><br><br><br> <table data-toggle="table" data-pagination="true" data-search="false" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        data-cookie-id-table="saveId" data-show-export="" >
                                        <thead>
                                            <tr>
                                                <!--<th data-field="state" data-checkbox="true"></th>-->
                                                <th data-field="id">Admission Number</th>
                                                ...
                                                <th data-field="religion" data-editable="true">Religion</th>
                                                <th data-field="caste" data-editable="true">Category</th>
...
?>
     ...
     <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br> <div class="footer-copyright-area">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
