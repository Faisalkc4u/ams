                        ...
                        <!--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">-->
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="Add Student.html"><i class="" aria-hidden="true"></i> Add New Student</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <?php 
echo form_open_multipart("Adminctlr/studchgpwd");
?>
<div class="input-group mg-b-pro-edt">
<span class=""><i class="" aria-hidden="true"></i></span>
Admission Number &nbsp;&nbsp;&nbsp;<input type="password" class="" name="cpwd"  placeholder="" required>
</div><br>
<div class="input-group mg-b-pro-edt">
<span class=""><i class="" aria-hidden="true"></i></span>
Current Password &nbsp;&nbsp;&nbsp;<input type="password" class="" name="cpwd"  placeholder="" required>
</div><br>
<div class="input-group mg-b-pro-edt">
<span class=""><i class="" aria-hidden="true"></i></span>
New Password &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" class="" name="npwd"  placeholder="" required>
</div><br>
<div class="input-group mg-b-pro-edt">
<span class=""><i class="" aria-hidden="true"></i></span>
Confirm Password &nbsp;&nbsp;&nbsp;<input type="password" class="" name="cnpwd"  placeholder="" required>
</div><br>
