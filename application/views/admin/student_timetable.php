...
<?php }?></li>
                                ...
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="" aria-hidden="true"></i>  Set Students' Timetable</a></li>
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                  <?php echo form_open_multipart("Adminctlr/student_tmtbl");?>   
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="input-group-btn">
                                                                    <button  class="btn btn-primary"type="submit" id="myBtn">Search</button>
                                                                </span>
                                                            </td>
                                                        </tr> 
                                                        </table>  
                                                ...
                                                {
                                                ?>   
                                                <table  class="table"border='0' cellpadding='0' cellspacing='0' width='480px' align='center' id="time_table"> 
                                                    <tr><h1 align="center">Time Table</h1></tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <td><input type="text" disabled class="monday" value="<?php  echo isset($table[$i][$j])? $table[$i][$j]:'Free'  ?>" ></td>
                                        ...
                                        <?php if(isset($table)) 
                                        {
                                         echo form_open_multipart("Adminctlr/store_student_timetable");?>   
                                                    <table border='0' width='480px' cellpadding='0' cellspacing='0' align='center'>
                                                        <tr> <td>&nbsp;</td> </tr>
                                                        <tr>
                                                            <td align='center'>Course</td>
                                                            <td>
                                                                <input type="text"  name="crs" value="<?php  echo $course ?>" disabled >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                            <input type="text" name="sem"  value="<?php  echo $semester ?>" disabled>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php
                                                                    foreach($lecture as $user){
                                                                ?> 
                                                                <option value="<?php echo $user->tid;?>"><?php echo $user->name;?></option>
                                                                <?php
                                                                    }
                                                                ?>
                                                                </select> 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <select name="subject" id="subject" >
                                                                ...
                                                                ?> 
                                                                <option value="<?php echo $user->subcode;?>"><?php echo $user->subname;?></option>
                                                                <?php
                                                                    }
                                                                ?>
                                                                </select> 
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="input-group-btn">
                                                                    <button  class="btn btn-primary"type="submit" id="myBtn">Update</button>
                                                                </span>
                                                            </td>
                                                        </tr> 
                                                        </table>  
