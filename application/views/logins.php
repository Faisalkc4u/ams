...
<head>
    ...
    <!-- Google Fonts
		============================================ -->
    <link href="https://
    fonts.googleapis.com/css?family=Play:400,700" rel="stylesheet">
    <!-- Bootstrap CSS
		============================================ -->
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="back-link back-backend">
                    <!--<a href="<?php echo base_url(); ?>assets/index.html" class="btn btn-primary"></a>-->
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4 col-md-4 col-sm-4 col-xs-12">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <?php echo form_open("Adminctlr/log");?>
