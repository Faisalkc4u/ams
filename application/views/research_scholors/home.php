                    ...
                    <nav class="classy-navbar justify-content-between" id="akameNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                ...
                                <ul id="nav">
                                    <li class=""><a href="<?php echo base_url();?>index.php/studentctlr/research_home">Home</a></li>
                                    <li><a href="<?php echo base_url();?>index.php/studentctlr/research_profile">Profile</a>
