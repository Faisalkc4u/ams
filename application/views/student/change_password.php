...
<?php 
echo form_open_multipart("studentctlr/send_email");
?>
...
<?php }?></li>
        ...
        <span style="color: red">*</span>You can send email to admin requesting to change password
     
<div class="input-group mb-3"> 
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-default">To</span>
  </div>
    <input class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" type = "email" name = "to" value="admin@gmail.com"  readonly>
</div>
<div class="input-group mb-3">
  <div class="input-group-prepend">
