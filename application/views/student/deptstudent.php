                ...
                <div class="row h-100 align-items-center">
                    ...
                    <div class="col-7">
                        <div class="top-header-content text-right">
                            <p><i class="fa fa-clock-o" aria-hidden="true"></i> Mon-Fri: 9.30 to 4.00 <span class="mx-2"></span> | <i class="" aria-hidden="true"></i><a href="<?php echo base_url();?>index.php/studentctlr/studhome" class="text-white"> Back</a><span class="mx-2"></span></p>
                        </div>
                    </div>
                </div>
            </div>
...
<br>
<?php 
echo form_open("studentctlr/deptstudent");
?>
<p>Mangattuparamba campus is situated on Kannur’s rural area, and this campus has spread across 21.73 acres. This campus has a canteen and staff amenity centre and also a gymnasium. 
    <br>The university also offers hostels for both boys and girls.</p>
<?php echo form_close();
?>
<!-- Footer Area Start -->
