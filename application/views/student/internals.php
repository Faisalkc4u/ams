                ...
                <div class="row h-100 align-items-center">
                    ...
                    <div class="col-7">
                        <div class="top-header-content text-right">
                            <p><i class="fa fa-clock-o" aria-hidden="true"></i> Mon-Fri: 9.30 to 4.00 <span class="mx-2"></span> | <i class="" aria-hidden="true"></i><a href="<?php echo base_url();?>index.php/Adminctlr/back" class="text-white"> Back</a><span class="mx-2"></span></p>
                        </div>
                    </div>
                </div>
            </div>
...
<br>
<?php 
echo form_open("studentctlr/inter");
?>

<table>
<tr><td><h2><font face="arialblack" >Your Internal Mark...</font></h2></td></tr>
<div class="input-group mg-b-pro-edt">
<tr><td><br>Register Number </td>
<td><br><input type="text" name="regno"  required>
</td></tr></div>
...
<tr><td><br><input type="submit" value="View" name="v"></td></tr></table>
<?php echo form_close();
?>
<!-- Footer Area Start -->
