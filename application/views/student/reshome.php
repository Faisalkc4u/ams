                ...
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="akameNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    <li class=""><a href="<?php echo base_url();?>index.php/studentctlr/reshome">Home</a></li>
                                    <li><a href="">Profile</a>
                                        <ul class="dropdown">
                                            <!--<li><a href="./index.html"> </a></li>-->
                                            <li><a href="<?php echo base_url();?>index.php/studentctlr/deptstudent">About Us</a></li>
                                            <li><a href="<?php echo base_url();?>index.php/studentctlr/studfacilities"> Facilities</a></li>
                                    ...
                                    <!--<li><a href="#">Faculties</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="#">View</a>
                                                <ul class="dropdown">
                                                <li><a href="<?php echo base_url();?>index.php/studentctlr/resprofile">Profile</a></li>
