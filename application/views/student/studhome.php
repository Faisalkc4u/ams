                ...
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="akameNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    <li class=""><a href="<?php echo base_url();?>index.php/studentctlr/studhome">Home</a></li>
                                    <li><a href="<?php echo base_url();?>index.php/studentctlr/student_profile">Profile</a>
                                    ...
                                    <!--<li><a href="#">Faculties</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="#">View</a>
                                                <ul class="dropdown">
                                                    ...
                                                    <li><a href="<?php echo base_url();?>index.php/studentctlr/timetable">Timetable</a></li>
                                                    <li><a href="<?php echo base_url();?>index.php/studentctlr/internals">Internal Marks</a></li>
                                                    <li><a href="<?php echo base_url();?>index.php/studentctlr/studattend">Attendance</a></li>
                                                   <li><a href="<?php echo base_url();?>index.php/studentctlr/assignment">Assignment</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="<?php echo base_url();?>index.php/studentctlr/change_password">Change Password</a>
                                                <li><a href="<?php echo base_url();?>index.php/studentctlr/leaveapply">Leave Apply</a></li>
                                     ...
                                     <!--<li><a href="#">Courses</a>
                                        <ul class="dropdown">
                                     <li><a href="./index.html"> MCA</a></li>
                                 <li><a href="./about.html">MCA- LE</a></li>
                                             
<li><a href="./service.html">MSc</a></li>
                     <li><a href="./service.html">MPhil</a></li>
                              <li><a href="./service.html">PhD</a></li>
                                            </ul></li>-->
