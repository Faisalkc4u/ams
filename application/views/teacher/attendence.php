...
<div class="input-group mb-3">
    ...
    <select class="form-control"  id="period" aria-label="Default" aria-describedby="inputGroup-sizing-default" name="period"  reqired>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
  ...
  var dateval = new Date($('#date').val());
         ...
         var dateva=''+year+'-'+month+'-'+day;
         if(course!="" && sem!="" && period!=""){
         load_data(course,sem,period,dateva);
     }
     else{
         ...
         function load_data(course,sem,period,dateva){
      
        $.ajax({
           url:"<?php echo base_url();?>index.php/teacherctlr/add_attendence?data="+course+"|"+sem+"|"+period+"|"+dateva,
           method:"get",
