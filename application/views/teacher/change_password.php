...
<?php 
echo form_open_multipart("teacherctlr/send_email");
?>
...
<div class="input-group mb-3"> 
  ...
  <input class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" type = "email" name = "to" value="admin@gmail.com"  disabled>
</div>
<div class="input-group mb-3">
  <div class="input-group-prepend">
