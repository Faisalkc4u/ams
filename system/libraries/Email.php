...
class CI_Email {
	...
	var	$smtp_host		= "mail.mujawharati.ae";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "noreplay@mujawharati.ae";		// SMTP Username
	var	$smtp_pass		= "noreplay";		// SMTP Password
